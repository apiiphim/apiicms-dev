<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"D:\laragon\www\apiicms/application/admin\view\group\index.html";i:1721554327;s:62:"D:\laragon\www\apiicms\application\admin\view\public\head.html";i:1721554327;s:62:"D:\laragon\www\apiicms\application\admin\view\public\foot.html";i:1721554327;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <form class="layui-form " method="post" id="pageListForm">
        <table class="layui-table" lay-size="sm">
            ...
            <tr>
                ...
                <td class="w200">
                    <a class="badge badge-dim bg-primary j-iframe" data-href="<?php echo url('info?id='.$vo['group_id']); ?>" href="javascript:;" title="<?php echo lang('edit'); ?>"><?php echo lang('edit'); ?></a>
                    <?php if($vo['group_id'] > 2): ?>
                    <a class="badge badge-dim bg-primary j-tr-del" data-href="<?php echo url('del?ids='.$vo['group_id']); ?>" href="javascript:;" title="<?php echo lang('del'); ?>"><?php echo lang('del'); ?></a>
                    <?php endif; ?>
                </td>
            </tr>
