<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:80:"D:\laragon\www\apiicms-dev/application/admin\view\collect\apiiphim_hoathinh.html";i:1721473368;s:66:"D:\laragon\www\apiicms-dev\application\admin\view\public\head.html";i:1721554327;s:66:"D:\laragon\www\apiicms-dev\application\admin\view\public\foot.html";i:1721554327;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="page-container p10">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">CÀO NGUỒN HOẠT HÌNH VIETSUB & THUYẾT MINH TỔNG HỢP</h4>
        </div>
        <div class="card-body">
            <form id="crawl-form">
                <div class="mb-3">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        buttonCrawlOne.addEventListener('click', () => {
            ...
            fetch("<?php echo url('crawl_apiiphim_hoathinh_link'); ?>", {
                method: "POST",
                headers: {
        ...
        const crawl_page_callback = (currentPage) => {
            const urlPageCrawl = `https://apii.online/apii/danh-sach?category=hoat-hinh&page=${currentPage}`;
            ...
            fetch("<?php echo url('crawl_apiiphim_hoathinh_page'); ?>", {
                method: "POST",
                headers: {
                    'Content-Type': 'application/json'
                },
        ...
        const crawl_movies = () => {
            ...
            fetch("<?php echo url('crawl_apiiphim_hoathinh_movies'); ?>", {
                method: "POST",
                headers: {
                    'Content-Type': 'application/json'
                },
