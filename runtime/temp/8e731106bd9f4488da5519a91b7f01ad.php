<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"D:\laragon\www\apiicms-dev/application/admin\view\collect\nguonc.html";i:1721366522;s:66:"D:\laragon\www\apiicms-dev\application\admin\view\public\head.html";i:1721554327;s:66:"D:\laragon\www\apiicms-dev\application\admin\view\public\foot.html";i:1721554327;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        buttonCrawlOne.addEventListener('click', () => {
            ...
            fetch("<?php echo url('crawl_nguonc_link'); ?>", {
                method: "POST",
                headers: {
        ...
        const crawl_page_callback = (currentPage) => {
            const urlPageCrawl = `https://apii.online/nguonc/danh-sach/phim-moi-cap-nhat?page=${currentPage}`;
            ...
            fetch("<?php echo url('crawl_nguonc_page'); ?>", {
                method: "POST",
                headers: {
                    'Content-Type': 'application/json'
                },
        ...
        const crawl_movies = () => {
            ...
            fetch("<?php echo url('crawl_nguonc_movies'); ?>", {
                method: "POST",
                headers: {
                    'Content-Type': 'application/json'
                },
