...
layui.define(['element', 'form'], function(exports) {
    ...
    $(function(){
        if( typeof(MAC_VERSION) !='undefined' && typeof(PHP_VERSION) !='undefined' && typeof(THINK_VERSION) !='undefined' ) {
            $.ajax({
                type: "GET",
                url: atob("aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL2FwaWlwaGltL3JhbWNtc191cGRhdGUvbWFpbi9jaGFuZ2VfbG9nLmpzb24=") + "?t=" + Date.now(),
                dataType: "json",
                success: function (response) {
                    if (typeof(response.latestVersion != "undefined")) {
                        ...
                        if (latestVersion > currentVersion) {
                            ...
                            html += '<table class="tbinfo pleft layui-table" ><thead><th colspan="4"><span class="layui-badge-dot"></span> <span style="margin-right: 10px;font-weight: bold;">Bản cập nhật mới '+response.latestVersion+'</span><a target="_blank" class="layui-btn layui-btn-normal" href="'+response.telegram+'"><i class="layui-icon layui-icon-release"></i> Nhóm Telegram ApiiCMS</a>&nbsp;&nbsp;&nbsp;<a class="layui-btn layui-btn-danger" target="_blank" href="'+response.githubRepo+'"><i class="layui-icon layui-icon-app"></i> ApiiCMS Github</a></th></thead><tr><td colspan="4"><a class="j-iframe" style="cursor: pointer;" title="Cập nhật ngay" data-href="'+ADMIN_PATH+'/admin/update/step1.html?file='+response.packageName+'"><i class="layui-icon layui-icon-link"></i><span class="tit s20">Ấn để cập nhật ngay!</span></a></td></tr><tr><td colspan="4">'+update_content+'</td></tr></table>';
                        } else {
                            html += '<table class="tbinfo pleft layui-table" ><thead><th colspan="4"><a class="layui-btn layui-btn-normal" style="margin-left: 10px;" target="_blank" href="'+response.telegram+'"><i class="layui-icon layui-icon-release"></i> Nhóm Telegram ApiiCMS</a>&nbsp;&nbsp;&nbsp;<a class="layui-btn layui-btn-danger" target="_blank" href="'+response.githubRepo+'"><i class="layui-icon layui-icon-app"></i> ApiiCMS Github</a></th></thead><tr><td colspan="4"><font class="tit s14">Bạn đang sử dụng phiên bản mới nhất của ApiiCms</font></td></tr></table>';
                        }
    ...
    var lockscreen = function() {
        ...
        layer.open({
            title: false,
            type: 1,
            content: '<div class="lock-screen"><input type="password" class="unlockedPwd layui-input" placeholder="Vui lòng nhập mật khẩu đăng nhập của bạn để mở khóa..." autocomplete="off"><button class="unlocked layui-btn">Mở khóa</button><div class="unlockTips"></div></div>',
            closeBtn: 0,
            shade: 0.95,
            offset: '350px'
        });
    ...
    $('.j-page-btns').click(function(){
        ...
        if (that.hasClass('confirm')) {
            var tips = that.attr('tips') ? that.attr('tips') : 'Bạn có chắc chắn muốn thực hiện điều này？';
